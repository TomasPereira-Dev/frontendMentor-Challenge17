...
const Home = () => {
    return (
        <main className="flex flex-col gap-16 mb-16">
           <section className="flex items-center justify-center h-screen bg-mobileHero bg-center bg-cover bg-no-repeat md:bg-tabletHero lg:bg-desktopHero">
                <div className="flex flex-col items-center justify-center text-center">
                    <p className="text-white/75 font-thin tracking-[0.6rem] mb-8 md:text-sm">NEW PRODUCT</p>
                    <h1 className="text-4xl text-white font-bold max-w-[10ch] md:text-6xl">XX99 MARK II HEADPHONE</h1>
                    <p className="text-white/75 my-8 max-w-[32ch] md:max-w-[38ch]">Experience natural, lifelike audio and exeptional build quality made for the passionate music enthusiast.</p>
           ...
           <section className="grid grid-cols-1 gap-4 px-4 md:grid-cols-2">
                ...
                bg-cta bg-patternCircles bg-no-repeat bg-top bg-contain rounded-lg
                md:col-span-2">
                    ...
                    <h2 className="text-4xl text-white text-center font-bold max-w-[8ch] 
                    md:text-6xl">ZX9 SPEAKER</h2>
                    <p className="text-center text-white/75 max-w-[30ch]
                    md:max-w-[36ch]">Upgrade to premium speakers that are phenomenally build to deliver truly remarkable sound.</p>
