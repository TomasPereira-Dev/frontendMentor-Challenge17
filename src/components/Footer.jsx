    ...
    return (
        <footer className="relative flex flex-col gap-8 px-4 py-12 bg-bg1">
            ...
            <div className="flex flex-col items-center gap-8 ">
                ...
                md:text-left md:max-w-full">Audiophile is an all in one stop to fulfill your audio needs. We&apos;re a small team of music lovers and sound specialists who are devoted to helping you get the most out of personal audio. Come and visit our demo facility - we&apos;re open 7 days a week.</p>
