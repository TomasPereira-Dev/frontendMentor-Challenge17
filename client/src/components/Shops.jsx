...
const Shops = ({hamburgerIsOpen, setHamburgerIsOpen}) => {
    return (
    <div className={`BACKGROUND ${hamburgerIsOpen && 'absolute top-[5rem] z-40 w-full h-full'}`} onClick={(e) => {e.target.classList.contains('BACKGROUND') && setHamburgerIsOpen(false)}}>
        <div className={`grid grid-cols-1 gap-20 px-4 py-16 bg-white max-w-[375px] ${hamburgerIsOpen && 'shadow-lg'}
        md:grid-cols-3 md:gap-6 md:mx-auto md:max-w-none lg:px-0 lg:py-8`}>
